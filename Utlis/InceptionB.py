...
class InceptionB():
    ...
    def bulid(self,inputmodel):
        #branch1
        branch3x3 = IndiviualCNN(32,3,3,name = self.name+"inceptionb3x3",strides = (2,2)).bulid(inputmodel)

        #branch2
        branch3x3_1 = IndiviualCNN(32,1,1,name = self.name+"inceptionb3x3_1").bulid(inputmodel)
        branch3x3_2 = IndiviualCNN(32,3,3,name = self.name+"inceptionb3x3_2").bulid(branch3x3_1)
        branch3x3_3 = IndiviualCNN(32,3,3,name = self.name+"inceptionb3x3_3",strides = (2,2)).bulid(branch3x3_2)
