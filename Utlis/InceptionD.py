...
class IndiviualCNN():
    ...
    def __init__(self, filters,num_row, num_col,name,strides = (1,1)):
        ...
        self.eps = 0.01
        self.conv_name = self.name+'_conv'
        self.Kernel_regularizer = l2(0.2)
...
class InceptionD():
    ...
    def bulid(self,inputmodel):
        #branch1
        branch3x3_1 = IndiviualCNN(32,1,1,name = self.name+"inceptiond3x3").bulid(inputmodel)
        branch3x3_2 = IndiviualCNN(32,3,3,name = self.name+"inceptiond13x3",strides = (2,2)).bulid(branch3x3_1)

        #branch2
#         branch7x7_1 = IndiviualCNN(32,1,1,name = self.name+"inceptiond7x7_1").bulid(inputmodel)
#         branch7x7_2 = IndiviualCNN(32,1,7,name = self.name+"inceptiond7x7_2").bulid(branch7x7_1)
#         branch7x7_3 = IndiviualCNN(32,7,1,name = self.name+"inceptiond7x7_3").bulid(branch7x7_2)
#         branch7x7_4 = IndiviualCNN(32,3,3,name = self.name+"inceptiond7x7_4",strides = (2,2)).bulid(branch7x7_3)

        #branch3
        branchpool = MaxPooling2D((3, 3),strides=(2, 2),padding='same')(inputmodel)

#         output = [branch3x3_2,branch7x7_4,branchpool]
        output = [branch3x3_2,branchpool]
        #concancate
