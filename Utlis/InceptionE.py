...
class IndiviualCNN():
    ...
    def __init__(self, filters,num_row, num_col,name,strides = (1,1)):
        ...
        self.eps = 0.01
        self.conv_name = self.name+'_conv'
        self.Kernel_regularizer = l2(0.4)
...
class InceptionE():
    ...
    def bulid(self,inputmodel):
        #branch1
        branch1x1_1 = IndiviualCNN(32,1,1,name = self.name+"inceptione1x1").bulid(inputmodel)

        
        #branch2
        branch3x3_1 = IndiviualCNN(32,1,1,name = self.name+"inceptione3x3_1").bulid(inputmodel)
        branch3x3_2a = IndiviualCNN(32,1,3,name = self.name+"inceptione3x3_2a").bulid(branch3x3_1)
        branch3x3_2b = IndiviualCNN(32,3,1,name = self.name+"inceptione3x3_2b").bulid(branch3x3_1)
        branch3x3 = concatenate([branch3x3_2a, branch3x3_2b], axis=3, name = self.name+"inceptione3x3_concat1")
        
        branch3x3_2 = IndiviualCNN(32,1,1,name = self.name+"inceptione3x3_2").bulid(inputmodel)
        branch3x3_3 = IndiviualCNN(32,1,1,name = self.name+"inceptione3x3_3").bulid(branch3x3_2)
        branch3x3_4a = IndiviualCNN(32,1,3,name = self.name+"inceptione3x3_4a").bulid(branch3x3_3)
        branch3x3_4b = IndiviualCNN(32,3,1,name = self.name+"inceptione3x3_4b").bulid(branch3x3_3)
        ...
        branchpool_1 = IndiviualCNN(32,1,1,name = self.name+"incewptionebranchpool1").bulid(branchpool)
