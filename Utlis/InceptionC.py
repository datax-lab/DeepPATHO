...
class InceptionC():
    ...
    def bulid(self,inputmodel):
        #branch1
        branch1x1 = IndiviualCNN(32,1,1,name = self.name+"inceptionc1x1").bulid(inputmodel)
...
#         branch7x7_3 = IndiviualCNN(192,7,1,name = self.name+"inceptionc7x7_3").bulid(branch7x7_2)
        ...
        branch7x7_b5 = IndiviualCNN(32,1,7,name = self.name+"inceptionc7x7c_5").bulid(branch7x7_b4)
