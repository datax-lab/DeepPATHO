...
#         self.dil5 = Indiviualdilation(80,3,3,name = name+"dil5")
    ...
    def bulid(self,inputmodel):
        ...
        Dil3 = Indiviualdilation(32,3,3,name = self.name+"dil3").bulid(Dil2)
        Max1 = MaxPooling2D((3, 3),strides=(2, 2),padding='same')(Dil3)
        Dil4 = Indiviualdilation(32,1,1,name = self.name+"dil4").bulid(Max1)
        Dil5 = Indiviualdilation(32,3,3,name = self.name+"dil5").bulid(Dil4)
